...
CREATE TABLE `ilance_categories` (
  `cid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Categories Primary Key',
  `categories_name` varchar(250) DEFAULT NULL COMMENT 'Name Of The Categories ',
  PRIMARY KEY (`cid`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='categories table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `ilance_categories` WRITE;
/*!40000 ALTER TABLE `ilance_categories` DISABLE KEYS */;
INSERT INTO `ilance_categories` VALUES (1,'category 1'),(2,'category 2'),(3,'category 3');
/*!40000 ALTER TABLE `ilance_categories` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-03-21  8:30:35
